...
namespace MKTS.Controllers.Data
{
    public class PartnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PartnerID,PartnerName")] Partner partner)
        {
            if (ModelState.IsValid)
            {
                var checkData = _context.Partner.Where(a => a.PartnerName == partner.PartnerName);
                if (checkData.Any())
                {
                    ModelState.AddModelError("PartnerName", "Record Already Exist with the same name");
                    return View(partner);
                }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(short id, [Bind("PartnerID,PartnerName")] Partner partner)
        {
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> DeleteConfirmed(short PartnerID)
        {
        ...
        private bool PartnerExists(short id)
        {
