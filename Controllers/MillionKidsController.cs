...
namespace MKTS.Controllers
{
    public class DashboardData
    {
        ...
        public List<string> YouthFacilitation { get; set; }
        public List<int> YouthBoys { get; set; }
        public List<int> YouthGirls { get; set; }
    ...
    public class MillionKidsController : Controller
    {
        // GET: MillionKidsController
        ...
        public MillionKidsController(ILogger<HomeController> logger, ApplicationDbContext context)
        {
            _logger = logger;
            _context = context;
        ...
        // GET: MillionKidsController/Details/5
